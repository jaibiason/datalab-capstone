...
<body>
    <div class="sidenav-settings settings-reqs">
    <?php require("sidenav.php"); ?>
    <div class="container1">
        <div class="title">
            <a href="settings.php"><svg width="23" height="20" viewBox="0 0 23 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <h1> Schedule Requirement Settings </h1>
        </div>
        ...
        <div class="sched-ctg">
            <div class="title"> 
                <h2>Services</h2>
                <button class="btn-primary"> Add Services </button> 
            </div>
            <div class="items-wrap">
