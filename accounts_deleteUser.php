...
<body>
    ...
    <div class="title flex-col">
            ...
            <p>You are about to delete an existing user, are you sure you wanted to delete the user below?</p>
        </div>
        
        <div class="form-temp form-delete-user">

            <form action="">
                <div class="form-row">
                    <div>
                        <label for="name">Name</label>
                        <input disabled type="text" class="gray" placeholder=" <?php echo "Jose Protacio Y Realonda" ?> ">
                    </div>
                    
                    <div>
                        <label for="code">Email Address</label>
                        <input disabled class="gray" type="text" placeholder=" <?php echo "Joserizal@gmail.com" ?> ">
                    </div>
