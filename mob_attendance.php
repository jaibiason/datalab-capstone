        ...
        <div class="form-temp form-btn-add-record">
            ...
            <div class="form-row">
                    <div>
                        ...
                        <input type="text" disasbled class="gray" placeholder="BIN-01">
                    </div>

                    <div>
                        <label for="eventDate">Service Name</label>
                        <input type="text" disabled class="gray" placeholder="Baptism Seminar">
                    </div>
                </div class="form-row">
                ...
                <div class="buttons-cont">
                    <!-- <button type="button" onclick="window.history.back()">Submit</button> -->
