...
<body >
    ...
    <section class="changepass-pg">
        <?php require("side_grad.php"); ?> 

        <div class="content">
            <button class="btn-back" type="button" onclick="window.history.back()"><svg width="23" height="20" viewBox="0 0 23 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="container1">
                ...
                <p>If your email address has a valid account Datalab, we have sent an OTP on your email. 
                    <br>Check your email and enter the OTP below.</p>
                <form action="">
                    <input type="text" class="otp" placeholder="Enter OTP">
                    <input type="submit" class="margin" name="submit" value="Continue">
                </form>
            </div>
