...
<body>
    <div class="sidenav-calendar view-userRecords">
    ...
    <div class="container1">
        ...
        <div class="sched-details">
            ...
            <div class="view-user-nav web">
                <div>
                    <a type="button" id="defaultOpen" class="tablinks active" onclick="showUserRecord(event, 'Attendees')" href="#">Attendees List</a>
