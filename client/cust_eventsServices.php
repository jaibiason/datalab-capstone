...
<body>
    ...
    <div class="container1">
        <div class="title">
            ...
            <h1>Events/Services Calendar</h1>
        </div>

        <div class="cal-header">
            <!-- <h1> <?php echo "March 2022" ?> </h1> -->
            ...
            <div class="cal-controls">
                ...
                <div class="next-prev">
                    <span class="cal-month__previous"> <img src="../assets/cal-prev.svg" alt=""> </span>
                    <span> Today </span>
                    <span class="cal-month__next"> <img src="../assets/cal-next.svg" alt=""> </span>
                </div>
        ...
        <div class="calendar">
                ...
                <div class="calendar__body">
                    ...
                    <div class="cal-body__week">        
                        <!-- include .event for indicator when date has a booking  -->
                        <div class="cal-body__day"></div>
                        <div class="cal-body__day"></div>
                        <div class="cal-body__day"></div>
                        <div class="cal-body__day"></div>
...
<!-- Calendar Library + JS -->
    ...
    <script src="js/cust_calendar.js"></script>
</html>