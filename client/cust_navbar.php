        ...
        <section class="navbar-top">
            ...
            <div class="top-icons ">
                ...
                <a href="" class="user-wrapper web">
                    ...
                    <h3> <?php echo "Andres Bonifacio" ?> </h3>
                </a>
            ...
            <!-- MOBILE -->
                <ul class="nav mobile">
                    ...
                    <li class="navlink <?php if ($page == "dashboard") {echo "active-page";} ?>"><a href="client_dashboard.php">Dashboard
                        <svg width="24" height="21" viewBox="0 0 24 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M14 0.5L12.57 1.893L20.15 9.5H0V11.5H20.15L12.57 19.073L14 20.5L24 10.5L14 0.5Z" fill="white"/>
                        </svg>
                    </a></li>
                    <li class="navlink <?php if ($page == "bookings") {echo "active-page";} ?>" ><a href="client_bookings.php">Bookings
                        <svg width="24" height="21" viewBox="0 0 24 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M14 0.5L12.57 1.893L20.15 9.5H0V11.5H20.15L12.57 19.073L14 20.5L24 10.5L14 0.5Z" fill="white"/>
                        </svg>
                    </a></li>
                    <li class="navlink <?php if ($page == "events") {echo "active-page";} ?>"><a href="client_events.php">Calendar
                        <svg width="24" height="21" viewBox="0 0 24 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M14 0.5L12.57 1.893L20.15 9.5H0V11.5H20.15L12.57 19.073L14 20.5L24 10.5L14 0.5Z" fill="white"/>
                        </svg>
                    </a></li>
