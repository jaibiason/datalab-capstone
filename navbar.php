        ...
        <section class="navbar-top">
            ...
            <!-- MOBILE -->
                <ul class="nav mobile">
                    ...
                    <li class="navlink"><a href="#">Notifications</a></li>
                    <li class="navlink"><a href="#">Logout</a></li>
                    <li class="navlink" ><a href="#">Dashboard
                        <svg width="24" height="21" viewBox="0 0 24 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M14 0.5L12.57 1.893L20.15 9.5H0V11.5H20.15L12.57 19.073L14 20.5L24 10.5L14 0.5Z" fill="white"/>
                        </svg>
                    </a></li>
                    <li class="navlink" ><a href="#">Bookings
                        <svg width="24" height="21" viewBox="0 0 24 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M14 0.5L12.57 1.893L20.15 9.5H0V11.5H20.15L12.57 19.073L14 20.5L24 10.5L14 0.5Z" fill="white"/>
                        </svg>
                    </a></li>
                    <li class="navlink"><a href="#">Calendar
                        <svg width="24" height="21" viewBox="0 0 24 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M14 0.5L12.57 1.893L20.15 9.5H0V11.5H20.15L12.57 19.073L14 20.5L24 10.5L14 0.5Z" fill="white"/>
                        </svg>
                    </a></li>
                    <li class="navlink" ><a href="#">Records
                        <svg width="24" height="21" viewBox="0 0 24 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M14 0.5L12.57 1.893L20.15 9.5H0V11.5H20.15L12.57 19.073L14 20.5L24 10.5L14 0.5Z" fill="white"/>
                        </svg>
                    </a></li>
                    <li class="navlink" ><a href="#">Finances
                        <svg width="24" height="21" viewBox="0 0 24 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M14 0.5L12.57 1.893L20.15 9.5H0V11.5H20.15L12.57 19.073L14 20.5L24 10.5L14 0.5Z" fill="white"/>
                        </svg>
                    </a></li>
                    <li class="navlink" ><a href="#">Accounts
                        <svg width="24" height="21" viewBox="0 0 24 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M14 0.5L12.57 1.893L20.15 9.5H0V11.5H20.15L12.57 19.073L14 20.5L24 10.5L14 0.5Z" fill="white"/>
                        </svg>
                    </a></li>
                    <li class="navlink"><a href="#">Settings
                        <svg width="24" height="21" viewBox="0 0 24 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M14 0.5L12.57 1.893L20.15 9.5H0V11.5H20.15L12.57 19.073L14 20.5L24 10.5L14 0.5Z" fill="white"/>
                        </svg>
                    </a></li>
